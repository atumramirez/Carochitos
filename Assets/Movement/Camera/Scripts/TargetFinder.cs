...
public class TargetFinder : MonoBehaviour
{
    ...
    private void LockOn() 
    {
        ...
        if (currentTarget) 
        {
            ...
            targetCamera.Follow = characterHandler.currentCharacter.transform;
    ...
    private void LockOff() 
    {
        ...
        playerCamera.Follow = characterHandler.currentCharacter.transform;
        playerCamera.LookAt = characterHandler.currentCharacter.transform;
